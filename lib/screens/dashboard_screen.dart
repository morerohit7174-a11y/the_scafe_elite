...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    // ✅ Load bills stream after user is authenticated
    Future.microtask(() {
                                    ...
                                    Badge(
                                      ...
                                      child: OutlinedButton.icon(
                                        onPressed: () => showDialog(
                                            context: context,
                                            builder: (_) =>
                                                const HoldOrdersPanel()),
                                        icon: const Icon(
                                            Icons.pause_circle_outline,
                                            size: 15),
                                        label: const Text('Holds',
                          ...
                          LayoutBuilder(builder: (context, c) {
                            ...
                            children: [
                              StatsCard(
                                  title: "Today's Sales",
                                  value:
                                      '₹${today.totalSales.toStringAsFixed(2)}',
                                  subtitle: '${today.totalOrders} orders',
                                  icon: Icons.currency_rupee),
                              StatsCard(
                                  title: 'Cash Sales',
                                  value:
                                      '₹${today.cashSales.toStringAsFixed(2)}',
                                  icon: Icons.money),
                              StatsCard(
                                  title: 'UPI Sales',
                                  value:
                                      '₹${today.upiSales.toStringAsFixed(2)}',
